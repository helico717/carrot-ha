...
class VehicleEntity:
    ...
    def configure(self, entry, key, name, icon):
        ...
        legacy_keys = {'charge_power_kw': 'charge_power_w'}
        self._attr_unique_id = entry.data['device_id'] + '_' + legacy_keys.get(key, key)
        legacy = {'soc_percent':'battery','odometer_km':'odometer','outside_temp_c':'outside_temperature','aux_voltage':'auxiliary_voltage','charge_power_w':'estimated_charging_power','charge_power_kw':'estimated_charging_power'}
