...
`;
  ...
  body(v,trip,isTrip){
    ...
    const tiles=isTrip?`${metric('주행거리',n(trip.distance_m==null?null:trip.distance_m/1000,2),'km','map-marker-distance')}${metric('주행시간',duration(trip.duration_s),'','timer-outline')}${metric('평균속도',n(trip.duration_s?trip.distance_m/trip.duration_s*3.6:null,0),'km/h','speedometer-medium')}${metric('최고속도',n(this.maxSpeed(trip.route),0),'km/h','speedometer')}${metric('전비',n(trip.efficiency_km_kwh,1),'km/kWh','lightning-bolt',trip.energy_wh!=null?n(trip.energy_wh/1000,2)+' kWh 소비':'')}${metric('SOC 사용',n(trip.soc_used_percent,1),'%','battery-minus',trip.start_battery_wh!=null?n(trip.start_battery_wh/1000,1)+' → '+n(trip.end_battery_wh/1000,1)+' kWh':'')}`:
